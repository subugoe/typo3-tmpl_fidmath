...
page.headerData {
  10 = TEXT
  10.value = <!--[if IE 8]><link rel="stylesheet" href="fileadmin/template/main/css/screenIE8.css" type="text/css" media="screen" /><![endif]--><!--[if IE 7]><link rel="stylesheet" href="fileadmin/template/main/css/screenIE7.css" type="text/css" media="screen" /><![endif]--><!--[if IE 6]><link rel="stylesheet" href="fileadmin/template/main/css/screenIE6.css" type="text/css" media="screen" /><![endif]-->
  11 = TEXT
  11.value = <link rel="shortcut icon" href="http://vifamath.de/fileadmin/images/favicon.ico" type="image/ico" />
  12 = TEXT
...
# default language: German, sys_language.uid = 0
page.config {
  sys_language_uid = 0
  language = de
...
temp.mainTemplate {
  template = FILE
  template.file = fileadmin/template/vifamath.html
}
...
page {
  includeCSS {
  file1 = fileadmin/template/css/screen.css
  file1.media = screen
...
###page title with prefix "Vifamath"
config.noPageTitle = 2
page.headerData.20 = TEXT
page.headerData.20.value = Vifamath
...
page.includeCSS.file = typo3conf/ext/tmpl_fidmath/Resources/Public/Css/styles.css
